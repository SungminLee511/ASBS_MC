...
| 0 | Fam 0 | 0.5 | Metastable survival sweep as basin threshold | B7 | kappa3={4,8,12,16,18,20,24,32} | 5 | 2000 | — | YES | [~] 1/40 running (batch3: k3=4 s0) | [ ] | [ ] |
| 1 | Fam B1 | B1-rho-0.001 | Dead mode revival: rho=0.001, M=50 | B7 | rho=0.001, M=50 | 5 | 3000 | — | YES | [~] 3/5 done (batch2), 1/5 running (s3, batch3), s4 NaN→killed | [ ] | [ ] |
| 1 | Fam B1 | B1-rho-0.01 | Dead mode revival: rho=0.01, M=50 | B7 | rho=0.01, M=50 | 5 | 3000 | — | YES | [~] 3/5 done (batch2), 1/5 running (s3, batch3), s4 NaN→killed | [ ] | [ ] |
| 1 | Fam B1 | B1-rho-0.05 | Dead mode revival: rho=0.05, M=50 | B7 | rho=0.05, M=50 | 5 | 3000 | — | YES | [~] 2/5 done (batch2), 1/5 running (s3, batch3), s0+s4 diverged | [ ] | [ ] |
| 1 | Fam B1 | B1-rho-0.1 | Dead mode revival: rho=0.1, M=50 | B7 | rho=0.1, M=50 | 5 | 3000 | — | YES | [~] 2/5 done (batch2), 1/5 running (s3, batch3), s0+s4 diverged | [ ] | [ ] |
...
| 3 | 20+5+4+4 | ASBS_MC | 2026-04-17 21:50 | — | 🏃 Running | Backfills: B1-rho s3,s4 (×4 configs; all s4 NaN→killed, s3 running), A1 s3+s4 ✅, E1-S13 s1+s4 ✅ (s0+s3 NaN/exploded), E1-S12 s3+s4 ✅, E1-S23 s4 ✅. New: B1-ctrl s0–4 (5 running), B1-M10 s0–4 (5 running), B1-M200 s0–4 (5 running), Fam0.5 k3=4 s0 (1 running). |
